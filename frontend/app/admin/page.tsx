      ...
      <main className="flex-1 mt-16 md:mt-0 px-4 md:px-8 py-8">
        <div className="max-w-6xl mx-auto space-y-8">
          ...
          <div className="grid gap-4 grid-cols-1 md:grid-cols-2">
            ...
            >
              <div>
                <p className="text-lg font-semibold text-foreground group-hover:text-primary transition-colors">Manage All Properties</p>
          ...
          <div className="rounded-lg border border-border bg-card p-6">
            <h2 className="text-xl font-semibold text-foreground mb-4">Recently Updated Listings</h2>
            {properties.length > 0 ? (
              ...
              <p className="text-sm text-muted-foreground">No listings have been loaded yet.</p>
            )}
          </div>
        </div>
      </main>
