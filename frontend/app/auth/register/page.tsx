...
import { Building2, Mail, Lock, User, Eye, EyeOff, CheckCircle2, AlertCircle } from 'lucide-react'
    ...
    <div className="min-h-screen bg-background flex items-center justify-center px-4 py-8">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground">Join PropertyHub and start listing or browsing properties</p>
        </div>
        ...
        <div className="mt-6 text-center">
          <p className="text-muted-foreground">
            ...
            <Link href={ROUTES.LOGIN} className="text-primary hover:text-primary/90 font-semibold transition-colors">
              Sign In
            </Link>
          </p>
        </div>
